...
from eventgpt.datasets.datasets.coco_caption_datasets import (
    COCOCapDataset,
    COCOCapEvalDataset,
    NoCapsEvalDataset,
)
...
from eventgpt.datasets.datasets.video_caption_datasets import (
    VideoCaptionDataset,
    VideoCaptionEvalDataset,
)

from eventgpt.datasets.datasets.event_caption_datasets import (
    EventCaptionDataset,
    EventCaptionEvalDataset,
)
...
@registry.register_builder("event_caption")
class EventCapBuilder(BaseDatasetBuilder):
    train_dataset_cls = EventCaptionDataset
    eval_dataset_cls = EventCaptionEvalDataset

    DATASET_CONFIG_DICT = {
        "default": "configs/datasets/eventgpt/defaults_event_cap.yaml",
    }
