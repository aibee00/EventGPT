...
# backbone)
_C.MODEL.BACKBONE.CONV_BODY = "SWINT-FPN-RETINANET"
...
_C.MODEL.BACKBONE.PRETRAINED_PATH =  "/ssd/wphu/chatglm/LAVIS/pretrain_weights/glip_tiny_model_o365_goldg_cc_sbu_lvisbest.pth"
...
_C.MODEL.FPN.DROP_FIRST_FEATURE = True
# ---------------------------------------------------------------------------- #
# BIFPN options
# ---------------------------------------------------------------------------- #
_C.MODEL.BIFPN = CN()
