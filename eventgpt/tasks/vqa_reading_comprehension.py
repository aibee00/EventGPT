...
from eventgpt.common.dist_utils import get_rank, get_world_size, is_main_process
from eventgpt.common.registry import registry
from eventgpt.common.vqa_tools.vqa_eval import VQAEval as VQATool
from eventgpt.tasks.vqa import VQATask
