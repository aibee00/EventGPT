...
import torch
from eventgpt.models import BlipBase, load_model, load_model_and_preprocess
...
def load_model_and_preprocess_cache(name, model_type, is_eval, device):
    return load_model_and_preprocess(name, model_type, is_eval, device)
