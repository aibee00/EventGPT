...
<div align="center">
  ...
  <a href="https://pepy.tech/project/salesforce-eventgpt">
  <img alt="Downloads" src="https://pepy.tech/badge/salesforce-eventgpt">
  </a>
</div>
...
<a href="https://blog.salesforceairesearch.com/eventgpt-language-vision-library/">Blog</a>
</div>
...
## What's New: 🎉 
  ...
  * Jan 2023, LAVIS is now available on [PyPI](https://pypi.org/project/salesforce-eventgpt/) for installation!
...
## Table of Contents
  ...
  - [Technical Report and Citing LAVIS](#technical-report-and-citing-eventgpt)
  - [License](#license)
...
```bash
conda create -n eventgpt python=3.8
conda activate eventgpt
```

2. install from [PyPI](https://pypi.org/project/salesforce-eventgpt/)
```bash
pip install salesforce-eventgpt
```
...
```python
from eventgpt.models import model_zoo
print(model_zoo)
# ==================================================
# Architectures                  Types
# ==================================================
...
```python
import torch
from eventgpt.models import load_model_and_preprocess
device = torch.device("cuda" if torch.cuda.is_available() else "cpu")
...
```python
from eventgpt.datasets.builders import dataset_zoo
...
```python
from eventgpt.datasets.builders import load_dataset
...
## Contact us
If you have any questions, comments or suggestions, please do not hesitate to contact us at eventgpt@salesforce.com.
