...
if __name__ == "__main__":
    ...
    if sys.argv[1] == "0":
        ...
        # label_path = "/training/wphu/Dataset/eventgpt/eventgpt/annotations/label_result_530_llava-style-box_caption_en.json"  # AibeeQA
        label_path = "/training/wphu/Dataset/llava/AibeeQA/label_result_530_llava-style-box_caption_en_test.json"  # AibeeQA
        # label_path = "/training/wphu/Dataset/eventgpt/eventgpt/annotations/vqa_llava_style_box_caption_test.json"  # pretrain data(2万) label generated by grit
        RANDOM_IMAGE = False
        Image_save_path = "./test_output/llava_style_box_caption_stage2"
        Use_high_resolution = False  # 是否使用高分辨率图像
        USE_ROI = True 
        USE_NEW_IMAGE_WITH_BBOX = True
        ...
        if Use_high_resolution:
            ## loads BLIP2-OPT-2.7b, pix_364, txtlen_2048, num_query_64
            model_name="blip2_opt_llava_box_caption"
            model_type="pretrain_opt2.7b_llava_box_caption_vit_L364"
        else:
            if USE_ROI:
                ## loads BLIP2-OPT-2.7b caption model, without finetuning on coco.
                ...
                ## loads BLIP2-OPT-2.7b caption model, without finetuning on coco.
                model_name="blip2_opt_llava_box_caption"
                model_type="pretrain_opt2.7b_llava_box_caption"
